                        ...
                        <form name="form" action="../Controller/control.php" method="get">
                            ...
                            <div class="col-md-2" style="margin-top: 1.2%">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input name="DataIni" type="text" class="form-control pull-right" id="datepicker-inicio">
                                </div>
                                <!-- /.input group -->
                            </div>
                            <!-- /.form group -->
                            ...
                            <div class="col-md-2" style="margin-top: 1.2%">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input name="DataFim" type="text" class="form-control pull-right" id="datepicker-fim">
                                </div>
                                <!-- /.input group -->
                            </div>
                            <!-- /.form group -->
