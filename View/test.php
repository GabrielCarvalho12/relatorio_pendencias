<?php
//campos selecionados pelo o usuário
$codigo = $_GET['codigo'];
$data1 = $_GET['data1'];
$data2 = $_GET['data2'];
...
$cont = new Controle();
$cont->SelectEdu();
$cont->tabelaEdu($codigo, $data1, $data2);
        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <a href="index.php" class="navbar-brand"> <i> <img style="width: 55%; margin-top: -7%" src="../public/dist/img/logo.png"> </i></a>
                </div>

                <div style="margin-left: 45%; font-size: 150%; margin-top: 1%">
                        ...
                        <form name="form" action="../Controller/control.php" method="get">
                            ...
                            <div class="col-md-2" style="margin-top: 1.2%">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input value="<?php echo $data1?>" name="DataIni" type="text" class="form-control pull-right" id="datepicker-inicio" data-inputmask='"mask": "99/99/9999"' data-mask>
                                </div>
                                <!-- /.input group -->
                            </div>
                            <!-- /.form group -->
                            ...
                            <div class="col-md-2" style="margin-top: 1.2%">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input value="<?php echo $data2?>" name="DataFim" type="text" class="form-control pull-right" id="datepicker-fim" data-inputmask='"mask": "99/99/9999"' data-mask>
                                </div>
                                <!-- /.input group -->
                            </div>
                            <!-- /.form group -->
                                        ...
                                        if($cont->Query!= NULL){
                                            ...
                                            while ($row = ibase_fetch_object($cont->Query)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo utf8_encode($row->ALUNO) ?></td>
